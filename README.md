...
<table>
  <tr>
    <td width="34%" align="center">
      <img src="docs/showcase-prompt-engineer-cover-qingchen-v2.jpg" width="300" alt="Prompt Engineer AI explainer comic cover with a subtle full-canvas QINGCHEN watermark pattern" />
    </td>
